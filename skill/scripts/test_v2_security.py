#!/usr/bin/env python3
"""Inherited composition, signature, dependency, and reinstall tests for Schema 4.0."""
...
def test_schema4_is_not_sent_through_legacy_migration():
    temp,root,_=fx.setup_project()
    try:

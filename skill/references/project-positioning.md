...
- Tauri, Electron, Unreal, and Capacitor signals create investigations in 0.3.4. Covered browser/generic evidence may be reused only for what those adapters explicitly prove.
